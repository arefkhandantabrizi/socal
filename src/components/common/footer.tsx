  ...
  return (
    <section className="footer">
      <div className="footer__items">
        <div className="footer__section footer_section--1">
        ...
        <div className="footer__section footer_section--2">
        ...
        <div className="footer__section footer_section--3">
        ...
        <div className="footer__section footer_section--4">
